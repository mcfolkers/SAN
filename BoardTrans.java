...
double[][] m = {	{ x, 0.0, 0.0 },
	...
	xyz_point.x = rotated_xyz.data[0][0]+rotated_xyz.data[0][1]+this.getCoordX();
	xyz_point.y = rotated_xyz.data[1][1]+rotated_xyz.data[1][0]+this.getCoordY();
	xyz_point.z = rotated_xyz.data[2][2]+this.getCoordZ();
//xyz_point.x = 23;
//	xyz_point.y = 23;
//	xyz_point.z = 23;
	return(xyz_point);
